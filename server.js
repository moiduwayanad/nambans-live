...
// ചോദ്യങ്ങൾ questions.json ലേക്ക് സേവ് ചെയ്യുന്നു
...
// ലോഗോ ഫയൽ ഏത് പേരിൽ കിടന്നാലും കണ്ടുപിടിച്ച് അയക്കുന്ന റൂട്ട്
app.get('/app-logo', (req, res) => {
  const possibleNames = ['logo.png', 'logo.jpg', 'logo.png.jpg', 'logo.png.jpeg', 'logo.jpeg'];
